...
export default function Call_Robot_R2() {
  const [choice, setChoice] = useState(true);
  const [button_call, setbutton_call] = useState(false);

  const route = useRoute<RouteProp<RootStackParamList, "Call_robot_R2">>();
  const navigation =
  ...
  // ตรวจสอบค่าที่ส่งกลับมาจากหน้า Call_rebot_list_R2 (ผ่าน merge: true)
  useEffect(() => {
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          <TouchableOpacity
            onPress={() => {
              ...
              navigation.navigate("TabR2", { screen: "Home" });
            }}
        ...
        >
          ...
          <View
            // activeOpacity={0.7}
            // onPress={() => {
            //   navigation.navigate("Call_rebot_list_R2");
            // }}
            style={{
              backgroundColor: "#eeeeee4b",
              width: "100%",
